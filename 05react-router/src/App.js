/**
react-router-dom
  : 리엑트는 기본적으로 화면의 새로고침 없이 화면을 갱신한다. 이 경우
...
Switch
  ...
  렌더링 하지않는 역할을 한다. 즉 최초로 발견되는 컴포넌트 하나만 렌더링
  한다. 
Link
  : a 태그를 통한 링크는 클릭할때마다 화면의 새로고침되어 갱신된다. React는
  화면의 깜빡임이 없어야 하므로, 링크를 눌렀을때 reload되지 않도록 처리해준다.
*/
